            ...
            <div class="d-flex">
              ...
              <div class="d-flex order-lg-2 ml-auto">
                <div class="nav-item d-none d-md-flex">
                  <a href="https://github.com/tabler/tabler" class="btn btn-sm btn-outline-primary" target="_blank">Исходный код</a>
                </div>
                ...
                <div class="dropdown">
                  <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                    ...
                    <span class="ml-2 d-none d-lg-block">
                      ...
                      <small class="text-muted d-block mt-1">Администратор</small>
                    </span>
                  </a>
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    ...
                    <a class="dropdown-item" href="#">
                      ...
                      <i class="dropdown-icon fe fe-mail"></i> Входящие
                    </a>
                    <a class="dropdown-item" href="#">
                      <i class="dropdown-icon fe fe-send"></i> Сообщение
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#">
                      <i class="dropdown-icon fe fe-help-circle"></i> Нужна помощь?
                    </a>
                    <a class="dropdown-item" href="#">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  <li class="nav-item">
                    <a href="./index.html" class="nav-link"><i class="fe fe-home"></i> На главную</a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="col-lg-4">
                <div class="card card-profile">
                  ...
                  <div class="card-body text-center">
                    ...
                    <h3 class="mb-3">Джон Доу</h3>
                    <p class="mb-4">
                      Такой себе пользователь
                    </p>
                    <button class="btn btn-outline-primary btn-sm">
                      <span class="fa fa-twitter"></span> Следовать
                    </button>
                  </div>
                </div>
                <div class="card">
                  ...
                  <div class="card-body">
                    <form>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="5">Такой себе пользователь</textarea>
                      </div>
                      <div class="form-group">
                        <label class="form-label">Email</label>
                        <input class="form-control" placeholder="your-email@domain.com"/>
